<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\www\youme\think\public/../application/index\view\article\article.html";i:1509975262;s:68:"F:\www\youme\think\public/../application/index\view\common\head.html";i:1509961763;s:70:"F:\www\youme\think\public/../application/index\view\common\footer.html";i:1508655809;}*/ ?>
...
<li><a href="<?php echo url('index/index'); ?>">首页</a></li><li>
	<?php if(is_array($tags) || $tags instanceof \think\Collection || $tags instanceof \think\Paginator): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<a href="<?php echo url('cate/cate',array('cateid' => $vo['id'])); ?>" title="<?php echo $vo['tagname']; ?>"><?php echo $vo['tagname']; ?></a></li><li>
...
<div class="post multi-post cate2 auth1">
		...
		<h2 class="post-title"><a href=""><?php echo $vo['title']; ?></a></h2>
		<div class="post-body"><p><?php echo $vo['desc']; ?><br/></p></div></br>
		<img src="
				<?php if($vo['pic'] != ''): ?>
				...
				<?php endif; ?>
		"alt=" " width="250px">
		<div class=""><p style="font-size:15px;">文章内容：<br/></p></div>

			</br></br>
		<div class=""><p style="font-size:24px;margin-left:10%"><?php echo $vo['content']; ?><br/></p></br></br>
		<h5 class="post-tags">Tags: <span class="tags"><a href="">{vo.tags.tagname}</a>&nbsp;&nbsp;</span></h5>
		<h6 class="post-footer">
			发布:<?php echo $vo['author']; ?> 浏览:<?php echo $vo['click']; ?><span id="spn76"></span>
			<script type="text/javascript">LoadViewCount(76)</script> | <a href="">阅读全文 > </a>
	<?php endforeach; endif; else: echo "" ;endif; ?>
	</h6>
</div>
...
<dd class="function_c">
<ul><li style="text-overflow:ellipsis;"><a href="http://www.youmew.com/post/76.html#cmt1492" title="2016-7-14 20:22:16 post by 卢松松博客">说的很不错呢！</a></li>
	<li style="text-overflow:ellipsis;"><a href="http://www.youmew.com/post/68.html#cmt1491" title="2016-7-12 16:21:06 post by 52微商网">一个很好的微商货源平台，非常适合做微商推</a></li>
