<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"F:\www\youme\think\public/../application/index\view\cate\cate.html";i:1509962181;s:68:"F:\www\youme\think\public/../application/index\view\common\head.html";i:1509961763;s:70:"F:\www\youme\think\public/../application/index\view\common\footer.html";i:1508655809;}*/ ?>
...
<div class="post single-post cate2 auth1">
	<!-- <div class="post-nav">
		...
		<?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			...
			<h2 class="post-title"><a href="<?php echo url('article/article',array('arid' => $vo['id'])); ?>"><?php echo $vo['title']; ?></a></h2>
			<div class="post-body">
				...
				<p style="text-indent: 0em;">
					...
					<?php endif; ?>
					" title="<?php echo $vo['title']; ?>" width="250px" alt=""/>
				</p>
